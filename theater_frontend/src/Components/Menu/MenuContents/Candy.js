      ...
      if(this.state.showButtons === true){
          return(
             <Row>
                ...
                <Col>
                    <button onClick={() => this.props.addingSnickers()}> Snickers: $5  </button>
                    <button onClick={() => this.props.addingMM()}> MnMs: $5  </button>
                    <button onClick={() => this.props.addingReeses()}> Reeses: $5  </button>
                </Col>
             </Row>
