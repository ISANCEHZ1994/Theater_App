      ...
      if(this.state.showButtons === true){
          return(
             <Row>
                ...
                <Col>
                    <button onClick={() => this.props.addingSmallDrink()}> Small: $4  </button>
                    <button onClick={() => this.props.addingMediumDrink()}> Medium: $6  </button>
                    <button onClick={() => this.props.addingLargeDrink()}> Large: $8  </button>
                </Col>
             </Row>
